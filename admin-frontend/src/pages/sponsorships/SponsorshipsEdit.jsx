...
export default function SponsorshipsEdit() {
  ...
  return <div className="max-w-3xl"><PageHeader title="Edit Sponsor" backTo="/sponsorships" /><SponsorForm defaultValues={item} onSubmit={handleSubmit} loading={loading} /></div>
}
