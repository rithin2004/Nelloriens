...
export default function TourismEdit() {
  ...
  return <div className="animate-fade-in"><PageHeader title="Edit Tourism Place" backTo="/tourism" /><TourismForm defaultValues={item} onSubmit={handleSubmit} loading={loading} /></div>
}
