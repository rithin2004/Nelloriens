 ...
 * from the Swagger UI without guessing field names or formats.
 */
...
export const schemas = {
  ...
  UpdateUserRequest: {
    type: 'object',
    description: 'All fields are optional. Email changes also update Firebase Auth.',
    properties: {
  ...
  UserDocument: {
    ...
    properties: {
      _id:         { type: 'string', example: 'USR00002', description: 'Sequential ID. USR00001 is always the superadmin and cannot be deleted.' },
  ...
  CompanyRequest: {
    ...
    properties: {
      ...
      faviconUrl:  { type: 'string', example: 'https://storage.googleapis.com/nelloriens.appspot.com/company/favicon.ico' },
      socialLinks: {
        type: 'object',
        description: 'Free-form object. Add any social platform as a key.',
        example: {
  ...
  CreateNewsRequest: {
    ...
    properties: {
      ...
      slug:             { type: 'string', example: 'cm-jagan-inaugurates-flyover-trunk-road-nellore', description: 'Auto-generated from title if omitted.' },
      ...
      tags:             { type: 'array', items: { type: 'string' }, example: ['infrastructure', 'Jagan', 'Trunk Road', 'Nellore'] },
      ...
      metaTitle:        { type: 'string', example: 'New Flyover on Trunk Road Inaugurated | Nelloriens' },
      metaDescription:  { type: 'string', example: 'CM Jagan inaugurated the Trunk Road flyover in Nellore today, marking a major infrastructure milestone.' },
  ...
  NewsCategoryRequest: {
    ...
    properties: {
      ...
      slug: { type: 'string', example: 'politics', description: 'Auto-generated if omitted.' },
    },
  },
  ...
  CreateJobRequest: {
    ...
    properties: {
      ...
      tags:             { type: 'array', items: { type: 'string' }, example: ['React', 'Node.js', 'Fresher', 'IT', 'Nellore'] },
  ...
  CreateHistoryRequest: {
    ...
    properties: {
      ...
      order:       { type: 'integer', example: 3, description: 'Chronological display order. Use /history/reorder to bulk-update positions.' },
    },
  },
  ...
  CreateAdRequest: {
    type: 'object',
    required: ['title', 'placement', 'adsenseCode'],
    ...
    properties: {
      ...
      adsenseCode: { type: 'string', example: '<ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-..." data-ad-slot="..."></ins>', description: 'Raw ad HTML/script code from your advertiser.' },
      validFrom:   { type: 'string', format: 'date-time', example: '2025-04-15T00:00:00.000Z' },
      validUntil:  { type: 'string', format: 'date-time', example: '2025-04-30T23:59:59.000Z' },
  ...
  InstagramConnectRequest: {
    ...
    description: 'After connecting, posts are synced automatically. Manual post creation and editing are blocked while connected.',
    properties: {
  ...
  InstagramStatusResponse: {
    ...
    properties: {
      ...
      tokenExpiry:  { type: 'string', format: 'date-time', example: '2025-06-10T09:45:00.000Z', description: 'Approx 60 days from last refresh. Refresh before expiry using /instagram/refresh-token.' },
      manualMode:   { type: 'boolean', example: false, description: 'True when not connected — manual post creation and edit are allowed.' },
    },
  },
